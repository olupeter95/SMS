...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><span class="fas fa-arrow-circle-right" style="font-size:20px;"></span>&nbsp;Manage Librarian</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card-header bg-danger">
        <h4>Librarian Information Page</h4>
    </div>
    </div>
    <div class="m-2">
    <button type="button" data-toggle="modal" data-target="#mymodal" class="btn btn-dark"><span class="fas fa-plus-circle">&nbsp; Add Librarian Information</button>
    </div>
    <!--modal-->
    ...
    <h6 class="modal-title text-centered">Add New Librarian Information</h6>
    <button class="close" type="button" data-dismiss="modal">&times;</button>
    </div>
    <div class="modal-body">
    <div class="card-body bg-white">
    <form method="post" enctype="multipart/form-data" action="{{route('librarian.store')}}">
    @csrf
    <div class="row">
    <div class="col-md-12">
    <div class="form-row">
    ...
    <div class="col-md-9">
    <input type="text" class="form-control py-3" name="name" placeholder="enter Librarian name"/>
    </div>
    </div>
    </div>
    </div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">All Librarians</a>
  </li>
</ul>
...
<div class="float-left pl-2">
  <p>showing {{$librarian->count()}} of {{$librarian->total()}}</p>
  </div>
