...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><span class="fas fa-arrow-circle-right" style="font-size:20px;"></span>&nbsp;Manage Parent</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card-header bg-danger">
        <h4>Parent Information Page</h4>
    </div>
    </div>
    <div class="m-2">
    <button type="button" data-toggle="modal" data-target="#mymodal" class="btn btn-dark"><span class="fas fa-plus-circle">&nbsp; Add Parent Information</button>
    </div>
    <!--modal-->
    ...
    <h6 class="modal-title text-centered">Add New Parent Information</h6>
    ...
    <div class="col-md-9">
    <input type="text" class="form-control py-3" name="name" placeholder="enter parent's name"/>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-md-9">
    <input type="text" class="form-control py-3" name="profession" placeholder="profession"/>
    </div>
    </div>
    </div>
    </div>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#home">All Parent</a>
  </li>
</ul>
...
<div class="float-left pl-2">
  <p>showing {{$parent->count()}} of {{$parent->total()}}</p>
  </div>
